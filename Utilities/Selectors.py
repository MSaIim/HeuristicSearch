...
class SeqIntSelector(Form):
  ...
  def __init__(self):
    ...
    heuristicLabel = Label(heuLabelRow, text="Heuristics (Duplicates will be ignored):")
    ...
    # Weight1 label row
    weightLabelRow1 = Frame(self)
    weightLabelRow1.pack(fill=X)
    weightLabel1 = Label(weightLabelRow1, text="Enter weight for heuristic inflation:")
    weightLabel1.pack(side=LEFT, padx=(30,0), pady=(20, 5))
    ...
    self.weightEntry2.pack(fill=X, padx=(30,30), pady=(0,0), expand=True)
